...
//				.collect(Collectors.toList());
	...
	public String replaceByIndex(String str, int initialIndex, int finalIndex, String newValue) {
		StringBuilder sb = new StringBuilder();

		if (initialIndex != 0) {
			sb.append(str.substring(0, initialIndex));
		}

		sb.append(newValue);
		sb.append(str.substring(finalIndex + 1));
		return sb.toString();
	}
